<% with $Training %>
    ...
    <div class="row me-0 px-sm-5 px-md-9 justify-content-between">
        <aside class="col-sm-12 col-md-3 order-md-2 bg-white my-5 sticky-md-top py-4" style="height:fit-content;top: 120px;">
        ...
        <section class="col-sm-12 col-md-7 order-md-1">
            ...
            <% end_if %>
            <% if $Description %>
            <% include WhiteBlock Title="Objectifs", Data=$Description %>
            <% end_if %>
            <% if $Publics %>
